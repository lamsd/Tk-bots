/**
 * Function List:
 * 1. void TKInfraredReceiver::begin(void)
 * 2. int16_t TKInfraredReceiver::read(void)
 * 3. int16_t TKInfraredReceiver::available(void)
 * 4. bool TKInfraredReceiver::buttonState(void)
 */
#include "TKOrion.h"
#include <SoftwareSerial.h>

TKInfraredReceiver infraredReceiverDecode(PORT_6);
