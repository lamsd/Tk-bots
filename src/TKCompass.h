...
// TK Compass only has one address
#define COMPASS_DEFAULT_ADDRESS    (0x1E)   

//TK Compass Register Address
 ...
 * Class: TKCompass
 * \par Description
 * Declaration of Class TKCompass
 */
#ifndef TK_PORT_DEFINED
class TKCompass
#else // !TK_PORT_DEFINED
class TKCompass : public TKPort
#endif // !TK_PORT_DEFINED
{
public:
#ifdef TK_PORT_DEFINED
 ...
 */
  TKCompass(uint8_t port, uint8_t address);
#else
/**
 ...
 */
  TKCompass(uint8_t keyPin, uint8_t ledPin);
 ...
 *   address - the i2c address you want to set
 */
  TKCompass(uint8_t keyPin, uint8_t ledPin, uint8_t address);
#endif  //  TK_PORT_DEFINED
/**
 * \par Function
 *   setpin
