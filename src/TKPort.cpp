...
/***********************Port*********************/
/**
 * Alternate Constructor which can call your own function to map the TKPort to arduino port,
 ...
 *   slot - SLOT1 or SLOT2
 */
TKPort::TKPort(uint8_t port, uint8_t slot)
{
  s1 = mePort[port].s1;
  s2 = mePort[port].s2;
  _port = port;
 ...
 *   None
 */
bool TKPort::dRead1(uint8_t mode)
{
  bool val;
  pinMode(s1, mode);
  val = digitalRead(s1);
 ...
 *   None
 */
bool TKPort::dRead2(uint8_t mode)
{
  bool val;
  pinMode(s2, mode);
  val = digitalRead(s2);
 ...
 *   None
 */
void TKPort::dWrite1(bool value)
{
  pinMode(s1, OUTPUT);
 ...
 *   None
 */
void TKPort::dWrite2(bool value)
{
  pinMode(s2, OUTPUT);
 ...
 *   None
 */
void TKPort::aWrite1(int16_t value)
{
 ...
 *   None
 */
void TKPort::aWrite2(int16_t value)
{
 ...
 *   None
 */
void TKPort::reset(uint8_t port)
{
  s1 = mePort[port].s1;
  s2 = mePort[port].s2;
  _port = port;
 ...
 *   None
 */
void TKPort::reset(uint8_t port, uint8_t slot)
{
  s1 = mePort[port].s1;
  s2 = mePort[port].s2;
  _port = port;
 ...
 *   None
 */
uint8_t TKPort::pin(uint8_t port, uint8_t slot)
{
