 ...
 *   None
 */
TK7SegmentDisplay::TK7SegmentDisplay(void) : TKPort()
{
 ...
 */
TK7SegmentDisplay::TK7SegmentDisplay(uint8_t port) : TKPort(port)
{
  _dataPin = s1;
  _clkPin = s2;
 ...
 */
TK7SegmentDisplay::TK7SegmentDisplay(uint8_t dataPin, uint8_t clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
  pinMode(_clkPin, OUTPUT);
 ...
 */
void TK7SegmentDisplay::reset(uint8_t port)
{
  _port = port;
  s2    = mePort[port].s2;
  s1    = mePort[port].s1;
 ...
 */
void TK7SegmentDisplay::setpin(uint8_t dataPin, uint8_t clkPin)
{
  _dataPin = dataPin;
  _clkPin = clkPin;
  pinMode(_clkPin, OUTPUT);
 ...
 * \par Others
 */
void TK7SegmentDisplay::clearDisplay(void)
{
  uint8_t buf[4] = { ' ', ' ', ' ', ' ' };
  display(buf);
}
 ...
 *    None
 */
void TK7SegmentDisplay::init(void)
{
  clearDisplay();
}
 ...
 *    None
 */
void TK7SegmentDisplay::writeByte(uint8_t wr_data)
{
  uint8_t i;
  uint8_t cnt0;
 ...
 *    None
 */
void TK7SegmentDisplay::start(void)
{
 ...
 *    None
 */
void TK7SegmentDisplay::stop(void)
{
  digitalWrite(_clkPin, LOW);
  digitalWrite(_dataPin, LOW);
  digitalWrite(_clkPin, HIGH);
 ...
 *    None
 */
void TK7SegmentDisplay::write(uint8_t SegData[])
{
  uint8_t i;
 ...
 *    None
 */
void TK7SegmentDisplay::write(uint8_t BitAddr, uint8_t SegData)
{
  start();    // start signal sent to TM1637 from MCU
 ...
 *    None
 */
void TK7SegmentDisplay::display(uint16_t value)
{
 ...
 *    None
 */
void TK7SegmentDisplay::display(int16_t value)
{
 ...
 *    None
 */
void TK7SegmentDisplay::display(float value)
{
  uint8_t i=0;
  bool isStart = false;
  uint8_t index = 0;
 ...
 *    None
 */
void TK7SegmentDisplay::display(long value)
{
  display((double)value, 0);
}
 ...
 *    None
 */
int16_t TK7SegmentDisplay::checkNum(float v,int16_t b)
{
  if(b>=0)
  {
 ...
 *    None
 */
void TK7SegmentDisplay::display(double value, uint8_t digits)
{
Posotion_1:
  uint8_t buf[4] = { ' ', ' ', ' ', ' ' };
  uint8_t tempBuf[4];
 ...
 *    None
 */
void TK7SegmentDisplay::display(uint8_t DispData[])
{
  uint8_t SegData[4];
  uint8_t i;
  for (i = 0; i < 4; i++)
 ...
 *    None
 */
void TK7SegmentDisplay::display(uint8_t BitAddr, uint8_t DispData)
{
  uint8_t SegData;
 ...
 *    None
 */
void TK7SegmentDisplay::display(uint8_t BitAddr, uint8_t DispData, uint8_t point_on)
{
  uint8_t SegData;
 ...
 *    None
 */
void TK7SegmentDisplay::set(uint8_t brightness, uint8_t SetData, uint8_t SetAddr)
{
  Cmd_SetData = SetData;
  Cmd_SetAddr = SetAddr;
 ...
 *    None
 */
void TK7SegmentDisplay::setBrightness(uint8_t brightness)
{
 ...
 *    None
 */
void TK7SegmentDisplay::coding(uint8_t DispData[])
{
 ...
 *    None
 */
uint8_t TK7SegmentDisplay::coding(uint8_t DispData)
{
