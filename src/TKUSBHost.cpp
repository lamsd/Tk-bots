 ...
 *   None
 */
TKUSBHost::TKUSBHost() : TKPort(0)
{

}

TKUSBHost::TKUSBHost(uint8_t s1, uint8_t s2)
{
  HSerial = new TKSerial(s1,s2);
}
 ...
 */
TKUSBHost::TKUSBHost(uint8_t port) : TKPort(port)
{
  HSerial = new TKSerial(port);
}
 ...
 *    None
 */
void TKUSBHost::CH375_WR(uint8_t c)
{
  HSerial->write(c);
  delay(2);
#ifdef CH375_DBG
 ...
 *    None
 */
int16_t TKUSBHost::set_usb_mode(int16_t mode)
{
 ...
 *    None
 */
uint8_t TKUSBHost::issue_token( uint8_t endp_and_pid )
{
 ...
 *    None
 */
void TKUSBHost::wr_usb_data( uint8_t len, uint8_t *buf )
{
#ifdef CH375_DBG
  Serial.print("usb wr: ");
 ...
 *    None
 */
uint8_t TKUSBHost::rd_usb_data( uint8_t *buf )
{
  uint8_t i, len;
 ...
 *    None
 */
uint8_t TKUSBHost::set_addr( uint8_t addr )
{
  uint8_t irq;
 ...
 *    None
 */
uint8_t TKUSBHost::set_config(uint8_t cfg){
 ...
 *    None
 */
uint8_t TKUSBHost::clr_stall6(void)
{
 ...
 *    None
 */
uint8_t TKUSBHost::get_desr(uint8_t type)
{
 ...
 *    None
 */
void TKUSBHost::init(int8_t type)
{
  ch375_online = false;
  device_online = false;
  device_ready = false;
 ...
 *    None
 */
int16_t TKUSBHost::initHIDDevice()
{
