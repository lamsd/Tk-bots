 ...
 *   slot - SLOT1 or SLOT2
 */
TKEncoderNew::TKEncoderNew(uint8_t addr,uint8_t slot)
{
  _slot = slot - 1;
  address = addr;
}
 ...
 *   slot - SLOT1 or SLOT2
 */
TKEncoderNew::TKEncoderNew(uint8_t slot)
{
  _slot = slot - 1;
  address = 0x9;
}
 ...
 *   None
 */
TKEncoderNew::TKEncoderNew(void)
{
  address = 0x09;
}
 ...
 *    None
 */
void TKEncoderNew::setAddr(uint8_t i2cAddr,uint8_t slot)
{
  address = i2cAddr;
  _slot = slot - 1;
}
 ...
 *    None
 */
void TKEncoderNew::move(long angle, float speed, float lock_state)
{
  cmdBuf[0] = _slot;
  cmdBuf[1] = CMD_MOVE;
 ...
 *    None
 */
void TKEncoderNew::moveTo(long angle, float speed,float lock_state)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::runSpeed(float speed,float lock_state)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::runTurns(long turns, float speed,float lock_state)
{
 ...
 *    None
 */
void TKEncoderNew::setSpeedPID(float p,float i,float d)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::setPosPID(float p,float i,float d)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::setMode(uint8_t mode)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::setPWM(int pwm)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::setCurrentPosition(long pulse_counter)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
long TKEncoderNew::getCurrentPosition(void)
{
  long pos;
  char buf[8];
 ...
 *    None
 */
void TKEncoderNew::getSpeedPID(float * p,float * i,float * d)
{
  char buf[8];
 ...
 *    None
 */
void TKEncoderNew::getPosPID(float * p,float * i,float * d)
{
  char buf[8];
 ...
 *    None
 */
float TKEncoderNew::getCurrentSpeed(void)
{
  char buf[8];
  float speed;
  Wire.beginTransmission(address); 
 ...
 *    None
 */
void TKEncoderNew::sendCmd(void)
{
  Wire.beginTransmission(address); 
  for(int i=0;i<18;i++)
    Wire.write(cmdBuf[i]);       
 ...
 *    None
 */
float TKEncoderNew::getRatio(void)
{ 
  char buf[8];
  float ratio;
  Wire.beginTransmission(address); 
 ...
 *    None
 */
void TKEncoderNew::setRatio(float ratio)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
int TKEncoderNew::getPulse(void)
{ 
  char buf[8];
  int pulse;
  Wire.beginTransmission(address); 
 ...
 *    None
 */
void TKEncoderNew::setPulse(int pulse)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::setDevid(uint8_t devid)
{
  cmdBuf[0] = _slot;
 ...
 *    None
 */
void TKEncoderNew::runSpeedAndTime(float speed, float time, float lock_state)
{
  if(_lastTime == 0)
  {
    _lastTime = millis();
 ...
 *    None
 */
boolean TKEncoderNew::isTarPosReached(void)
{
  uint8_t buf[8];
  boolean lock_state;
  Wire.beginTransmission(address); 
 ...
 * \par Others
 */
void TKEncoderNew::getFirmwareVersion(char *buffer)
{ 
  Wire.beginTransmission(address); 
  Wire.write(_slot);      
