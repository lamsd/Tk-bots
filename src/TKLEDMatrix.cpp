 ...
 *   None
*/
TKLEDMatrix::TKLEDMatrix():TKPort()
{
...
*/
TKLEDMatrix::TKLEDMatrix(uint8_t port): TKPort(port)
{
	u8_SCKPin = s1;
	u8_DINPin = s2;
 ...
 */
TKLEDMatrix::TKLEDMatrix(uint8_t SCK_Pin, uint8_t DIN_Pin)
{
	u8_SCKPin = SCK_Pin; 
	u8_DINPin = DIN_Pin;
 ...
 *    None
 */
void TKLEDMatrix::reset(uint8_t port){
 ...
 *    None
 */
void TKLEDMatrix::writeByte(uint8_t data)
{
    //Start
    digitalWrite(u8_SCKPin, HIGH);
 ...
 *    None
 */
void TKLEDMatrix::writeBytesToAddress(uint8_t Address, const uint8_t *P_data, uint8_t count_of_data)
{
    uint8_t T_data;
 ...
 *    None
 */
void TKLEDMatrix::setBrightness(uint8_t Bright)
{
    if((uint8_t)Bright>8)
    {
        Bright = Brightness_8;
 ...
 *    None
 */
void TKLEDMatrix::setColorIndex(bool Color_Number)
{
 ...
 *    None
 */
void TKLEDMatrix::drawBitmap(int8_t x, int8_t y, uint8_t Bitmap_Width, uint8_t *Bitmap)
{
 ...
 *    None
 */
void TKLEDMatrix::drawStr(int16_t X_position, int8_t Y_position, const char *str)
{
    b_Draw_Str_Flag = 1;
 ...
 *    None
 */
void TKLEDMatrix::showClock(uint8_t hour, uint8_t minute, bool point_flag)
{
 ...
 *    None
 */
void TKLEDMatrix::showNum(float value,uint8_t digits)
{
Posotion_1:
