...
/**
 * Alternate Constructor which can call your own function to map the TKGyro to arduino port,
 * no pins are used or initialized here
 */
TKGyro::TKGyro(void) : TKPort(0)
{
 ...
 */
TKGyro::TKGyro(uint8_t port) : TKPort(port)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
}
 ...
 */
TKGyro::TKGyro(uint8_t port, uint8_t address) : TKPort(port)
{
 ...
 */
TKGyro::TKGyro(uint8_t AD0, uint8_t INT)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
  _AD0 = AD0;
  _INT = INT;
 ...
 *   address - the i2c address you want to set
 */
TKGyro::TKGyro(uint8_t AD0, uint8_t INT, uint8_t address)
{
  Device_Address = address;
  _AD0 = AD0;
  _INT = INT;
 ...
 */
void TKGyro::setpin(uint8_t AD0, uint8_t INT)
{
  _AD0 = AD0;
  _INT = INT;
#ifdef TK_PORT_DEFINED
 ...
 *   None
 */
uint8_t TKGyro::getDevAddr(void)
{
 ...
 *   Z-axis angle value is integral of Z-axis angular velocity.
 */
double TKGyro::getAngle(uint8_t index)
{
  if(index == 1)
  {
    return getAngleX();
 ...
 */
void TKGyro::deviceCalibration(void)
{
  int8_t return_value;
  uint16_t x = 0;
  uint16_t num = 500;
 ...
 */
int8_t TKGyro::writeReg(int16_t reg, uint8_t data)
{
 ...
 */
int8_t TKGyro::readData(uint8_t start, uint8_t *buffer, uint8_t size)
{
  int16_t i = 0;
  int8_t return_value = 0;
 ...
 */
int8_t TKGyro::writeData(uint8_t start, const uint8_t *pData, uint8_t size)
{
  int8_t return_value = 0;
  Wire.beginTransmission(Device_Address);
  return_value = Wire.write(start); 
